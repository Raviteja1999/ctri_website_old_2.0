 ...
 <li class="last"><a href="https://play.google.com/store/apps/details?id=com.icar.ctri&hl=en">Mobile App</a></li>
  ...
  <a title="Screen Reader" href="reader.php"><b><img src="images/screen.jpg" ></b></a>
		...
		<table border='0' width='900' cellspacing='20' class='profile'>
			...
			<tr><td rowspan='3' valign='top' width='150' align='left'><img src='uploads/staff/386.jpeg' height='140' width='115'/></td>

				<td valign='top' align='left' colspan='2'><b>Arvind Isukapatla</b><br/>M.Sc. (Biotech.)</td>

			</tr>

			<tr><td></td><td></td></tr>

			<tr><td valign='top' align='left'>Technical Assistant<b></b></td><td><b>Contact Address: </b><br/><br/>

				<img src='images/phoneicon.gif'/>Phone (Mobile):&nbsp;9160234587<br/>

				<img src='images/emailicon.gif'/>Email Address:&nbsp;arvindisuk@gmail.com<br/>
