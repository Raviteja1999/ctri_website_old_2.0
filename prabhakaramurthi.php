 ...
 <li class="last"><a href="https://play.google.com/store/apps/details?id=com.icar.ctri&hl=en">Mobile App</a></li>
  ...
  <a title="Screen Reader" href="reader.php"><b><img src="images/screen.jpg" ></b></a>
		...
		<table border='0' width='900' cellspacing='20' class='profile'>
			...
			<tr><td rowspan='3' valign='top' width='150' align='left'><img src='uploads/staff/86.jpg' height='140' width='115'/></td>

				<td valign='top' align='left' colspan='2'><b>Sri A.K. Maheshwari</b><br/>B.Sc.,M.A.</td>

			</tr>

			<tr><td></td><td></td></tr>

			<tr><td valign='top' align='left'>Sr. Finance & Accounts Officer<b></b></td><td><b>Contact Address: </b><br/>E-307, CASA Green, Talawali chanda, Indore<br/>

				<img src='images/phoneicon.gif'/>Phone (Mobile):&nbsp;9893791390<br/>

				<img src='images/emailicon.gif'/>Email Address:&nbsp;akmfao@gmail.com<br/>
			...
			<td colspan='2'><ul>
	<li>
		Assistant (Audit & Accounts) 1985 - 1995 (Sep)</li>
	<li>
		AO 1995(Oct) - 1999(Jan)</li>
	<li>
		AFAO 1999(Feb) - 2011 (Feb)</li>
<li>
		FAO  2011(Mar) - 2019  (June 25th) </li>
</ul>
</td></tr>
