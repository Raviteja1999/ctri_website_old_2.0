...
<h3 style="color:blue; text-align:left;"><a href="index.php" style="color:blue;">Home</a>&gt;Research Stations&gt;Jeelugumilli</h3>	
...
<h1 style="text-align: center; ">
	<span style="font-size:16px;"><span style="color: rgb(165, 42, 42); "><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;CTRI RESEARCH STATION, JEELUGUMILLI</strong></span></span></h1>	
...
<img  style='height:320px;width:700px' src="images/Jeelugumilli.JPG" alt="Jeelugumilli"></h3>

<p>Exportable type of flue cured tobacco is grown in Northern light soils of Andhra Pradesh covering 
...
<p>
	<span style="font-size:14px;">1. To evolve high yielding and disease resistant FCV and Natu tobacco varieties.  </span></p>
<p>
	<span style="font-size:14px;">2. To develop suitable crop management practices for producing semi flavourful to flavourful FCV tobacco.</span></p>
<p>
	<span style="font-size:14px;">3. To develop suitable crop management practices to Natu tobacco for getting higher yields of quality tobacco. </span></p>
<p>
	<span style="font-size:14px;">4. To develop alternate cropping systems suitable to that area.</span></p>
