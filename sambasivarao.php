 ...
 <li class="last"><a href="https://play.google.com/store/apps/details?id=com.icar.ctri&hl=en">Mobile App</a></li>
  ...
  <a title="Screen Reader" href="reader.php"><b><img src="images/screen.jpg" ></b></a>
		...
		<table border='0' width='900' cellspacing='20' class='profile'>
			...
			<tr><td rowspan='3' valign='top' width='150' align='left'><img src='uploads/staff/276.jpeg' height='140' width='115'/></td>

				<td valign='top' align='left' colspan='2'><b>N. Sambasiva Rao</b><br/>Intermediate, DCA</td>

			</tr>

			<tr><td></td><td></td></tr>

			<tr><td valign='top' align='left'>Technical Officer<b></b></td><td><b>Contact Address: </b><br/>CTRI, Rajahmundry<br/>

				<img src='images/phoneicon.gif'/>Phone (Mobile):&nbsp;8500815378<br/>

				<img src='images/emailicon.gif'/>Email Address:&nbsp;nimmadulasambasivarao@gmail.com<br/>
			...
			<td colspan='2'><ul>
	<li>
		Technician 1982 - 1988</li>
	<li>
		Senior Technician 1988 - 2000</li>
	<li>
		Technical Assistant 2000 - 2005</li>
	<li>
		Senior Technical Assistant 2005 - 2010</li>
	<li>
		Technical Officer 2010 - till date</li>
</ul>
</td></tr>
