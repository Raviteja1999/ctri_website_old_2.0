 ...
 <li class="last"><a href="https://play.google.com/store/apps/details?id=com.icar.ctri&hl=en">Mobile App</a></li>
  ...
  <a title="Screen Reader" href="reader.php"><b><img src="images/screen.jpg" ></b></a>
		...
		<table border='0' width='900' cellspacing='20' class='profile'>
			...
			<tr><td rowspan='3' valign='top' width='150' align='left'><img src='uploads/staff/282.jpeg' height='140' width='115'/></td>

				<td valign='top' align='left' colspan='2'><b>V. Annadurai</b><br/>Diploma in Agriculture, M.Sc. (Botany)</td>

			</tr>

			<tr><td></td><td></td></tr>

			<tr><td valign='top' align='left'>Senior Technical Officer<b></b></td><td><b>Contact Address: </b><br/>ICAR-CTRI RS, Vedasandur - 624710<br/>

				<img src='images/phoneicon.gif'/>Phone (Mobile):&nbsp;9443917424<br/>

				<img src='images/emailicon.gif'/>Email Address:&nbsp;prithviannadurai@yahoo.com<br/>
			...
			<td colspan='2'><ul>
	<li>
		Technician 1988 - 1994</li>
	<li>
		Senior Technician 1994 - 2001</li>
	<li>
		Senior Technical Assistant 2002 - 2006</li>
	<li>
		Technical Officer 2006 - 2011</li>
	<li>
		Senior Technical Officer 2011 to till date</li>
</ul>
</td></tr>
