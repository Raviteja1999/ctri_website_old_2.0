 ...
 <li class="last"><a href="https://play.google.com/store/apps/details?id=com.icar.ctri&hl=en">Mobile App</a></li>
  ...
  <a title="Screen Reader" href="reader.php"><b><img src="images/screen.jpg" ></b></a>
		...
		<table border='0' width='900' cellspacing='20' class='profile'>
			...
			<tr><td rowspan='3' valign='top' width='150' align='left'><img src='uploads/staff/328.jpeg' height='140' width='115'/></td>

				<td valign='top' align='left' colspan='2'><b>M. Mathaiah</b><br/>Possessing Heavy goods vehicles Driving licence</td>

			</tr>

			<tr><td></td><td></td></tr>

			<tr><td valign='top' align='left'>Senior Technical Assistant<b></b></td><td><b>Contact Address: </b><br/>Marellagunta palem(vi), Pedakotha palli (post),MADDIPADU (mandal),PRAKASAM-523 211<br/>

				<img src='images/phoneicon.gif'/>Phone (Mobile):&nbsp;85008 71989<br/>

				<img src='images/emailicon.gif'/>Email Address:&nbsp;mathaiah441@gmail.com<br/>
			...
			<td colspan='2'><ul>
	<li>
		Heavy Vehicle Driver (Tractor) 1993 - 1995</li>
	<li>
		Technician 1995 - 2001</li>
	<li>
		Senior Technician 2001 - 2011</li>
	<li>
		Technical Assistant 2011 - 2016</li>
	<li>
		Senior Technical Assistant 2016 - till date</li>
</ul>
</td></tr>
