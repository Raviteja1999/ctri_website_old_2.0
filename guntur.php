...
<h3 style="color:blue; text-align:left;"><a href="index.php" style="color:blue;">Home</a>&gt;Research Stations&gt;Guntur</h3>	
<br>
...
<h1 style="text-align: center; ">
	<span style="font-size:16px;"><span style="color: rgb(165, 42, 42); "><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;CTRI RESEARCH STATION, GUNTUR</strong></span></span></h1>	
...
<img  style='height:320px;width:700px' src="images/guntur.jpg" alt="guntur"></h3>

<p>The CTRI Research Station, Guntur was established in 1936 under aegis of Imperial 
...
<p>
	<span style="font-size:14px;">1. Evolving high yielding FCV, Natu and HDBRG varieties.  </span></p>
<p>
	<span style="font-size:14px;">2. Maintenance of Germplasm of Natu / HDBRG tobaccos.</span></p>
<p>
	<span style="font-size:14px;">3. Developing suitable crop management practices for higher yield and quality.</span></p>
<p>
	<span style="font-size:14px;">4. To work out alternative cropping systems to FCV tobacco. </span></p>

<p>
	<span style="font-size:14px;">5.  To develop pest management modules for effective control of major insect pests. </span></p>
