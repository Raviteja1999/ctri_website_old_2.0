 ...
 <li class="last"><a href="https://play.google.com/store/apps/details?id=com.icar.ctri&hl=en">Mobile App</a></li>
  ...
  <a title="Screen Reader" href="reader.php"><b><img src="images/screen.jpg" ></b></a>
		...
		<table border='0' width='900' cellspacing='20' class='profile'>
			...
			<tr><td rowspan='3' valign='top' width='150' align='left'><img src='uploads/staff/158.jpeg' height='140' width='115'/></td>

				<td valign='top' align='left' colspan='2'><b>Sri Penumetsa Satish</b><br/>B.Sc. (Chemistry)</td>

			</tr>

			<tr><td></td><td></td></tr>

			<tr><td valign='top' align='left'>Lower Division Clerk<b></b></td><td><b>Contact Address: </b><br/>Sathamvalasa Village and Post, Rajam (SO), Merakamudidam (Mandal), Vizianagaram (District) - 532127<br/>

				<img src='images/phoneicon.gif'/>Phone (Mobile):&nbsp;9494333947<br/>

				<img src='images/emailicon.gif'/>Email Address:&nbsp;satish.penumetsa@icar.gov.in<br/>
