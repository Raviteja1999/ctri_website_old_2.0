 ...
 <li class="last"><a href="https://play.google.com/store/apps/details?id=com.icar.ctri&hl=en">Mobile App</a></li>
  ...
  <a title="Screen Reader" href="reader.php"><b><img src="images/screen.jpg" ></b></a>
		...
		<table border='0' width='900' cellspacing='20' class='profile'>
			...
			<tr><td rowspan='3' valign='top' width='150' align='left'><img src='uploads/staff/simhachalam.jpg' height='140' width='115'/></td>

				<td valign='top' align='left' colspan='2'><b>Simhachalam Simma</b><br/>M.Sc.(Microbiology)</td>

			</tr>

			<tr><td></td><td></td></tr>

			<tr><td valign='top' align='left'>Technical Assistant<b></b></td><td><b>Contact Address: </b><br/>Room - C1, CTRI RS staff quarters, Jeelugumilli, W.G.Dist,  A.P. - 534456<br/>

				<img src='images/phoneicon.gif'/>Phone (Mobile):&nbsp;8790631631<br/>

				<img src='images/emailicon.gif'/>Email Address:&nbsp;chalamrishabchem@gmail.com<br/>

				</td></tr>

			<tr><td  valign='top' width='150' align='left'><b>Employment Record</b></td>

			<td colspan='2'>Technical Assistant - 2018 to till date</td></tr>
