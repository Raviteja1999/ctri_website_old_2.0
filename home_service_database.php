...
<h3 style="color:blue; text-align:left;"><a href="index.php" style="color:blue;">Home</a>&gt;Services&gt;Database</h3>	
...
<h1 style="text-align: center; ">
	<span style="font-size:16px;"><span style="color: rgb(165, 42, 42); "><strong>DATABASE DEVELOPED</strong></span></span></h1>

<strong>
<p>
	<span style="font-size:14px;">&bull;&nbsp;<a href='http://agridaksh.iasri.res.in/tobacco.jsp'>Tobacco Agridaksh : An online expert system</a></span></p>

<p>
	<span style="font-size:14px;">&bull;&nbsp;<a href='http://ctri.icar.gov.in/weeds/tobacco.html'>Knowledge base system for Tobacco Weed Management</a></span></p>

<p>
	<span style="font-size:14px;">&bull;&nbsp;Expert system for Diagnosis and Management of Plant Nutrient Disorders in Flue-Cured Tobacco (Nicotianatabacum L.)</a></span></p>

<p>
	<span style="font-size:14px;">&bull;&nbsp; Development of computational algorithm for prediction of miRNA in plants &nbsp; in FCV tobacco</span></p>

<p>
	<span style="font-size:14px;">&bull;&nbsp; Meteorological database management system </span></p>
<p>
	<span style="font-size:14px;">&bull;&nbsp; Rainfed Natu Tobacco germplasm information system </span></p>

<p>
	<span style="font-size:14px;">&bull;&nbsp; <em>Nicotiana </em> species information system </span></p>

<p>
	<span style="font-size:14px;">&bull;&nbsp; Database on agricultural pests &amp; diseases </span></p>
<p>
	<span style="font-size:14px;">&bull;&nbsp; Decision Support System on soil fertility evaluation and recommendation to FCV tobacco crop </span></p>

<p>
	<span style="font-size:14px;">&bull;&nbsp; Information system for FCV tobacco production and marketing trends in India. </span></p>

<p>
	<span style="font-size:14px;">&bull;&nbsp; Expert system for identification of major diseases in FCV tobacco. </span></p>
</strong>
<p>
	&nbsp;</p>
