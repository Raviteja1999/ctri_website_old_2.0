...
<li><a href="#">DOWNLOADS</a>
	...
	<div >		
		...
		<table border='0' width='900' cellspacing='20' class='profile'>
			...
			<tr><td rowspan='3' valign='top' width='150' align='left'><img src='uploads/staff/385.jpeg' height='140' width='115'/></td>

				<td valign='top' align='left' colspan='2'><b>Aasi Divya</b><br/>M.Sc. (Botany)</td>

			</tr>

			<tr><td></td><td></td></tr>

			<tr><td valign='top' align='left'>Technical Assistant<b></b></td><td><b>Contact Address: </b><br/>SFA-196, Autonagar, 
B.H.P.V. (Post),
Gajuwaka, Visakhapatnam, A.P.<br/>

				<img src='images/phoneicon.gif'/>Phone (Mobile):&nbsp;8143678780<br/>

				<img src='images/emailicon.gif'/>Email Address:&nbsp;aasidivyareddy@gmail.com<br/>
