...
<body>
    <div class="container">
        <header> <img src="images/header.jpg" alt="ctri"></header>
       
            <marquee id='news' direction="left" onMouseOver="stop();" onMouseOut="start();" behavior="scroll" scrollamount="5"><p>THIS WEBSITE BELONGS TO CENTRAL TOBACCO RESEARCH INSTITUTE,RAJAHMUNDRY, INDIAN COUNCIL OF AGRICULTURAL RESEARCH, AN AUTONOMOUS ORGANIZATION UNDER THE DEPARTMENT OF AGRICULTURAL RESEARCH AND EDUCATION, MINISTRY OF AGRICULTURE, GOVERNMENT OF INDIA</p></marquee>
            ...
            <ul id="menu_main">
                ...
                <li><a href="#">FOR FARMERS</a>
                    <ul>
                        ...
                        <li><a href='files/varieties_released.pdf' target="_blank">Varieties Released</a></li>
                ...
                <li><a href="#">ANNOUNCEMENTS</a>
                    <ul>
                        ...
                        <li><a href='files/sca.pdf' target="_blank">Circulars</a></li>
                ...
                <li><a href="files/vision.pdf">VISION 2050</a></li>
