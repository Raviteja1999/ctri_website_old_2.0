<!DOCTYPE html><html lang="en"><head><link href="css/home.css" rel="stylesheet" type="text/css"><link rel="icon" type="image/png" href="images/fav.png"><meta charset="utf-8"><title>Documents  | CTRI,Rajahmundry</title><link type="text/css" href="menu.css" rel="stylesheet"><style type="text/css"><!--.style2 {	font-size: 11px;	font-weight: bold;}--></style></head><body><div class="container" id="container">	<header>	<img  style='height:125px;width:100%' src="images/header.jpg" alt="ctri">	</header>		<nav>
    	<ul id="menu">
...
<li><a href="#">DOWNLOADS</a>
 ...
 <li class="last"><a href="https://play.google.com/store/apps/details?id=com.icar.ctri&hl=en">Mobile App</a></li>
  ...
  <a title="Screen Reader" href="reader.php"><b><img src="images/screen.jpg" ></b></a>
		...
		<div class="content">	<h3 style="color:blue; text-align:left;"><a href="index.php" style="color:blue;">Home</a>&gt;Downloads&gt;Documents</h3>		<input type="button" id="btn" value="Print" onclick="printDiv();" style="float:right"><div id="content"><br><h1 style="text-align: center; "><span style="font-size:16px;"><span style="color: rgb(165, 42, 42); "><strong>DOCUMENTS</strong></span></span></h1><br />

<p ><b>  Phethai Cyclone in AP - Impacts on FCV Tobacco and Advisories for Mitigation </b>(<a href="files/phethai.pdf" target="_blank">  sclick here to Download</a>) </p>

<p ><b>  Swachhta Hi Sewa 2018</b>(<a href="files/swa.pdf" target="_blank">  sclick here to Download</a>) </p>
...
<p> <b>JULY-DECEMBER,2017</b>(<a href="files/news172.pdf">click here to download</a>)</p>
 ...
 <br><p><b>ARCHIEVES</b> &nbsp; (<a href="archieve.php">click here to open</a>)</p><p>	&nbsp;</p></div>	   <br class="clear" /></div><!-- Class Content End --><div class="footer"><p><span class="right"><a href="disclaimer.php">DISCLAIMER</a> |       <a href="webpolicy.php">WEB POLICY </a> |    <a href="privacy.php">PRIVACY POLICY</a></span>

<span class="left">&copy; <?php echo date("Y");?>  Reserved to Central Tobacco Research Institute.</span></p>
</div><!-- Container class End --></div><script type="text/javascript" src="js/jquery.js"></script><script type="text/javascript">    $(function() {   if ($.browser.msie && $.browser.version.substr(0,1)<7)	{	$('li').has('ul').mouseover(function(){	$(this).children('ul').css('visibility','visible');			}).mouseout(function(){		$(this).children('ul').css('visibility','hidden');			})		}        });function printDiv() {  var divToPrint=document.getElementById('content');  var newWin=window.open('','Print-Window');  newWin.document.open();  newWin.document.write('<html><body onload="window.print()">'+divToPrint.innerHTML+'</body></html>');  newWin.document.close();  setTimeout(function(){newWin.close();},10);}</script>	<script type="text/javascript" src="js/jquery.js"></script><script type="text/javascript">    $(function() {   if ($.browser.msie && $.browser.version.substr(0,1)<7)	{	$('li').has('ul').mouseover(function(){	$(this).children('ul').css('visibility','visible');			}).mouseout(function(){		$(this).children('ul').css('visibility','hidden');			})		} 	$('#incfont').on('click',function(){		curSize = parseInt($('body').css('font-size')) + 2;		if(curSize <= 20){			$('body').css('font-size',curSize);			$('body ul li a').css('font-size',curSize);			$('.content p').css('font-size',curSize);		}	});	$('#decfont').on('click',function(){		curSize = parseInt($('body').css('font-size')) - 2;		if(curSize >= 10){			$('body').css('font-size',curSize);			$('body ul li a').css('font-size',curSize);			$('.content p').css('font-size',curSize);		}	});	$('#norfont').on('click',function(){					$('body').css('font-size','12px');			$('body ul li a').css('font-size','12px');			$('.content p').css('font-size','14px');			});       	 });</script></html>